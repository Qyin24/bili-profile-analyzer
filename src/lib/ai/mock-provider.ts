/**
 * BiliProfile Analyzer — Phase 6.0 & 6.1: Local Deterministic AI Mock Provider
 *
...
/**
 * Generates a mock AI analysis result deterministically from a report input.
 */
export async function generateMockAiAnalysis(
...
/**
 * Singleton mock AI analysis provider.
 */
export const mockAiProvider: AiAnalysisProvider = {
  id: "MOCK",
  generate: generateMockAiAnalysis,
};
